package com.rockwell.confirmdialog;

import java.util.Arrays;
import java.util.HashMap;
import java.util.Locale;

import com.rockwell.confirmdialog.component.i18n.ButtonCaptionFactory;
import com.rockwell.confirmdialog.component.icons.ButtonIconFactory;
import com.rockwell.confirmdialog.component.icons.DialogIconFactory;
import com.rockwell.confirmdialog.component.icons.VaadinButtonIconFactory;
import com.rockwell.confirmdialog.component.icons.VaadinDialogIconFactory;
...
//    }
    ...
    public ConfirmDialog withButton(ButtonType buttonType,Icon buttonIcon,String buttonTheme, Runnable runOnClick, ButtonOption... options) {
        Button button = new Button(BUTTON_DEFAULT_CAPTION_FACTORY.translate(buttonType, DIALOG_DEFAULT_LOCALE));
        buttons.put(buttonType, button);
        ...
        if(buttonTheme != null)
        {
        	button.getElement().setAttribute("theme", buttonTheme);
        }
        if (BUTTON_DEFAULT_ICONS_VISIBLE) {
            button.setIcon(new Icon(BUTTON_DEFAULT_ICON_FACTORY.getIcon(buttonType)));
            if(buttonIcon != null)
